...
fn test_siren_bin_patch() raises:
...
fn test_quality_zero_disables() raises:
    """q=0 should disable a type."""
    var r = parse_accept("application/json;q=0")
    assert_false(r.wants_json)


fn test_quality_nonzero_enables() raises:
