...
def _ctx_add_one(ctx: PipelineContext[Int]) -> PipelineContext[Int]:
    return PipelineContext[Int](ctx.val + 1)


def _ctx_double(ctx: PipelineContext[Int]) -> PipelineContext[Int]:
    return PipelineContext[Int](ctx.val * 2)


def _ctx_exit(ctx: PipelineContext[Int]) -> PipelineContext[Int]:
    return ctx.with_exit()


def test_pipeline_context_basic() raises:
...
def test_pipe_ctx_2_normal() raises:
...
def test_pipe_ctx_2_early_exit() raises:
...
def test_pipe_ctx_3_normal() raises:
