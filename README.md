...
| `m0-wsgi` | WSGI/ASGI gateway — run Django, Flask, FastHTML, or any WSGI/ASGI app on this server | 163 |
...
uv run poe test-all         # 1074 unit tests, then compiles every example
