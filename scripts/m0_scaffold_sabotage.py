...
RULES = [
    ...
    ("new: the MAX pin token is left in place", "views", M0 + "new.py",
    ...
    ("image: the runtime image carries no libsqlite3", "-", T + "_common/deploy/Dockerfile",
     'ARG RUNTIME_LIBS="libsqlite3-0"\n', 'ARG RUNTIME_LIBS="ca-certificates"\n',
     "about.json is", IMAGE),
