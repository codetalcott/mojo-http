...
- **Throughput.** On a bare ASGI app it serves <!-- num:asgi-vs-uvloop@2 -->1.62<!-- /num -->x the
  ...
  <!-- num:granian-vs-m0-rps@2 -->0.99<!-- /num -->x in requests per second, a tie. The [benchmarks](../../docs/BENCHMARKS.md) have
